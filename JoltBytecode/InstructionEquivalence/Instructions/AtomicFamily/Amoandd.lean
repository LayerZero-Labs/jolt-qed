...
theorem amoanddProgram_doesNotWriteProtectedVRegs
    ...
    JoltISA.ProgramWritesNoProtectedVReg
      (JoltISA.amoanddProgramAuto rd rs1 rs2) := by
  unfold JoltISA.amoanddProgramAuto
  split
...
private theorem amoanddProgramCore_doesNotWriteProtectedVRegs
    (rs2 rs1 rd : regidx) :
    JoltISA.ProgramWritesNoProtectedVReg
...
private theorem amoanddProgram_core_eq_sail
  ...
  · exact
      amo_dword_double_binop_program_eq_sail_aligned
        ...
        (amoanddProgramCore_doesNotWriteProtectedVRegs rs2 rs1 rd)
...
theorem amoanddProgram_eq_sail
  ...
  have hcore := amoanddProgram_core_eq_sail rs2 rs1 rd js h
  cases hrd : JoltISA.isX0 rd <;>
    simpa only [JoltISA.amoanddProgramAuto,
      JoltISA.amoDoubleBinopProgram,
